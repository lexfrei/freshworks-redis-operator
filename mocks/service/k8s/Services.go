...
// CreateCertificate provides a mock function with given fields: namespace, cert
func (_m *Services) CreateCertificate(namespace string, cert *cmapi.Certificate) error {
	ret := _m.Called(namespace, cert)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, *cmapi.Certificate) error); ok {
		r0 = rf(namespace, cert)
	} else {
		r0 = ret.Error(0)
	}
...
// CreateOrUpdateCertificate provides a mock function with given fields: namespace, cert
func (_m *Services) CreateOrUpdateCertificate(namespace string, cert *cmapi.Certificate) error {
	ret := _m.Called(namespace, cert)
...
// UpdateCertificate provides a mock function with given fields: namespace, cert
func (_m *Services) UpdateCertificate(namespace string, cert *cmapi.Certificate) error {
	ret := _m.Called(namespace, cert)
...
func (_m *Services) GetCertificate(namespace string, name string) (*cmapi.Certificate, error) {
	...
	var r0 *cmapi.Certificate
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string) (*cmapi.Certificate, error)); ok {
		return rf(namespace, name)
	}
	if rf, ok := ret.Get(0).(func(string, string) *cmapi.Certificate); ok {
		r0 = rf(namespace, name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*cmapi.Certificate)
		}
	}
